...
func (s *Service) GetSimilarBookV2(c *gin.Context) {    //Update thành GetSimilarBookV2
	bookID := c.Param("id")
	limit := queryInt(c, "limit", 10)

	books, err := s.recRepo.GetSimilarBooksV2(c.Request.Context(), bookID, limit)   //Update thành GetSimilarBookV2
	if err != nil {
