...
export function HomeWideBanner() {
  return (
    <section className="mx-auto max-w-page px-4 py-5 sm:px-6 lg:px-10 xl:px-24">
      <Link
        href="/books"
      ...
      >
        ...
        <div className="relative flex min-h-[220px] max-w-[560px] flex-col justify-center px-5 py-8 sm:px-8 md:min-h-[260px]">
          <p className="text-[12px] font-medium uppercase tracking-[0.14em] text-sunburst">Ưu đãi trong tuần</p>
          <h2 className="mt-3 font-display text-[32px] font-semibold leading-[1.08] text-white sm:text-[42px]">
    ...
    >
      <div className="relative flex h-full w-full flex-col overflow-hidden rounded-cards bg-parchment">
        <div className="relative z-10 bg-white/94 px-3 py-3">
          <p className="text-[10px] font-medium uppercase leading-4 tracking-[0.14em] text-ash">{eyebrow}</p>
        ...
        <div
          ...
          aria-hidden="true"
        />
        <span className="m-2 inline-flex min-h-9 items-center justify-center rounded-buttons bg-white px-2 text-center text-[12px] font-medium text-charcoal shadow-subtle">
          {cta}
        </span>
      </div>
    </Link>
